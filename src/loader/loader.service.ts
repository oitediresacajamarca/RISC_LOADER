...
export class LoaderService {
    ...
    async DescargarReportePlano(mes: number, anio: number, sector: number) {
        ...
        let FECHA_INICIO_PERIODO =   moment(new Date(anio,mes-1,1)).format("YYYYMMDD")
...
*/
        ...
        let FECHA_INICIO_PERIODO_FORMAT =FECHA_INICIO_PERIODO


        let FECHA_FIN_PERIODO_FORMAT = moment(new Date(anio,mes-1,1)).endOf('month').format('YYYYMMDD')
        ...
        let resp = await fetch("https://wsalud.minsa.gob.pe/reporteshis/his/NominalTramaNuevo.aspx?parametro=7-7-----20210614-20210614", {
            "headers": {
              "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
              "accept-language": "es-ES,es;q=0.9,en;q=0.8",
              "cache-control": "no-cache",
              ...
              "sec-fetch-user": "?1",
              "upgrade-insecure-requests": "1",
              "cookie": "_ga_F4HY3YK7EH=GS1.1.1613481795.4.0.1613481795.0; _ga_LEDF527D3S=GS1.1.1615149485.2.0.1615149485.0; _ga_NWVQ3HSJKS=GS1.1.1616246531.42.0.1616246531.0; _ga_T513LTCYK1=GS1.1.1619054927.32.0.1619054927.0; _ga=GA1.3.1150659243.1611596987; _gid=GA1.3.1560812818.1623691110; rxVisitor=1623731070893GUHE7KUR6CNCVHBV8FNDPCEN2USA0GN0; dtSa=-; dtPC=1$131082160_896h-vKHPLPCNJJBOXJFMKKAAMAHCVMDGNKPLB; dtLatC=1; dtCookie=1$C1E881D9F16FD4B8A73E002E567C8DD2|HISMINSA|1|RUM+Default+Application|1; rxvt=1623732886464|1623731070896; ASP.NET_SessionId=2o1wk5b13nfw4kdt4gpypk4c"
            },
            "referrer": "https://wsalud.minsa.gob.pe/reporteshis/his/NominalTramaNuevo.aspx?parametro=7-7-----20210614-20210614",
            "referrerPolicy": "strict-origin-when-cross-origin",
            "body": "__EVENTTARGET=&__EVENTARGUMENT=&__VIEWSTATE=%2FwEPDwULLTEwMTQzMzA4NTAPZBYCAgMPZBYEAgMPDxYCHgRUZXh0BRdUb3RhbCBkZSByZWdpc3Ryb3MgNTY2MWRkAgUPPCsAHAIADxYCHg9EYXRhU291cmNlQm91bmRnZBg8KwAGAQUUKwACZGRkGAEFHl9fQ29udHJvbHNSZXF1aXJlUG9zdEJhY2tLZXlfXxYBBQJndtA2g0X%2BhUykv23dC4uXA7YsrKyThWJskVrTq1vLc2Aw&__VIEWSTATEGENERATOR=40BBBC33&__EVENTVALIDATION=%2FwEdAAstuxg6bLjp0xgtzyklt9Zx60z594LnSzU4S6PQAbT3rq%2FpNZX4WBzijQTqPezGz2dA7gw86B%2By7ZHTN%2BvyabRRNnYkKrbN%2FO3%2F80cAQIl6hUr4E8rNR8j1g%2BULBBtNNPuHCckrAtLUuxosmebAadYwj4xXkHQ%2BYn1IHjIKmCBZQcd656%2BJOgSd%2B0%2FH49X4pDTceTYcQ5kHq6daWfdlKKqcYwT%2BSUyhF5e0clSSWBJgLlyd64MYiWuJssZWRnkVMwAWFNZjOuQIskexerU8EC7s&btnExportar=Exportar+a+Excel&gv%24DXSelInput=&gv%24DXKVInput=%5B%5D
DBuUHAwcGAwcOBwIKMjAyMS0wNi0xNAcCA0FDVAMHJwMHAgMFVYgAAAcCDDIyMDIxOTQzNDkwMQcCCzQ2MDk4MTM0OTAxAwbcEgcCCDkwNzQ5LjAxBwIBRAcCATIHAAcABv%2F%2FAwV94JkdAwblBwMHBgMHDgcCCjIwMjEtMDYtMTQHAgNBQ1QDBycDBwIDBVWIAAAHAgwyMjAyMTk0MzQ5MDEHAgs0NjA5ODEzNDkwMQMG3BIHAgg5MDc0OS4wMQcCAUQHAgJBTQcABwAG%2F%2F8DBex%2BnB0DBuUHAwcGAwcOBwIKMjAyMS0wNi0xNAcCA0FDVAMHYwMHEAMGbxEHAgwxNDc5Mjc1NzQ0NjMHAgo0NzA2NTI0NDYzAwX%2BgTEBBwIIOTA3NDkuMDEHAgFEBwIBMgcABwAG%2F%2F8DBex%2BnB0DBuUHAwcGAwcOBwIKMjAyMS0wNi0xNAcCA0FDVAMHYwMHEAMGbxEHAgwxNDc5Mjc1NzQ0NjMHAgo0NzA2NTI0NDYzAwX%2BgTEBBwIIOTA3NDkuMDEHAgFEBwICQU0CBVN0YXRlB3EHEAcAAgEHAQIBBwICAQcDAgEHBAIBBwUCAQcGAgEHBwIBBwgCAQcJAgEHCgIBBwsCAQcMAgEHDQIBBw4CAQcPAgEHAAcABwAHAAIABQAAAIAJAgAHAAkCAAIAAwcEAgAHAAIBBh0WBwACAQcABwAHAAIIUGFnZVNpemUDBw8%3D&hdpidsector="+sector+"&hdpiddisa=7&hdpidred=&hdpidmicrored=&hdpidestablecimiento=&hdpidpunto=&hdpfecini="+FECHA_INICIO_PERIODO_FORMAT+"&hdpfecfin="+FECHA_FIN_PERIODO_FORMAT+"&DXScript=1_171%2C1_94%2C1_164%2C1_104%2C1_138%2C1_114%2C1_121%2C1_152&DXCss=0_3598%2C0_3741%2C1_12%2C0_3600%2C0_3745%2C0_3592%2C1_5%2C0_3594",
            "method": "POST",
            "mode": "cors"
          });
    ...
    async cargarPadronNominalProvincia(cod_prov: string, nombre_prov: string) {
        ...
        const rpt = fs.createWriteStream('E:/DIRESA/Nominales/1JULIO2021/' + nombre_prov + '.xlsx');
        console.log(cod_prov)

        let url = "https://padronnominal.reniec.gob.pe/padronn/reporte/padron_edad_xls.do?coUbigeo=" + cod_prov + "&deEdad=0&hastaEdad=5&deUbigeo=CAJAMARCA," + nombre_prov + "&feIni=01/01/2013&feFin=30/06/2021&tiRegFecha=T&esPadron=1"
        console.log(url)
        fetch(url, {
            "headers": {
                "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                ...
                "sec-fetch-user": "?1",
                "upgrade-insecure-requests": "1",
                "cookie": "JSESSIONID=fmFvpB-gq1xSheb8FGcW1dK6VmlXA1rzEkhvqwQFVgmiKa937wSm!-1488978403"
    ...
    async darBaja() {
        await fetch("https://websalud.minsa.gob.pe/hisminsa/security", {
            ...
            "referrer": "https://websalud.minsa.gob.pe/hisminsa/",
            "referrerPolicy": "strict-origin-when-cross-origin",
            "body": "C=USER&S=MOTIVOBAJAUPDATE&iduser=31000&idpersonal=461510&idperxeess=668794&motivobaja=cambio%20de%20region",
            "method": "POST",
            "mode": "cors"
        });
    }
