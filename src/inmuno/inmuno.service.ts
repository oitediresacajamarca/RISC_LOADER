...
export class InmunoService {
  ...
  async descargarVacCovid() {
    ...
    const rpt =await fs.createWriteStream(this.RUTA_CARGAR + '/VACUNAS/VACUNACION_COVID.csv');
  let respuesta=  await fetch("https://wsalud.minsa.gob.pe/reporteshis/Inmunizaciones/Vacunados.aspx?parametro=127-7-0-0-0-0-01%2f02%2f2021-14%2f05%2f2021", {
      "headers": {
        "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        "accept-language": "es-ES,es;q=0.9,en;q=0.8",
        "cache-control": "no-cache",
  ...
  async descargarVacCovidDisa(disa:string) {


    const rpt =await fs.createWriteStream(this.RUTA_CARGAR + '/VACUNAS/VACUNACION_COVID_'+disa+'.csv');
  let respuesta=  await fetch("https://wsalud.minsa.gob.pe/reporteshis/Inmunizaciones/Vacunados.aspx?parametro=127-7-0-0-0-0-01%2f02%2f2021-14%2f05%2f2021", {
      "headers": {
        "accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        "accept-language": "es-ES,es;q=0.9,en;q=0.8",
      ...
      "referrer": "https://wsalud.minsa.gob.pe/reporteshis/Inmunizaciones/Vacunados.aspx?parametro=127-7-0-0-0-0-01/02/2021-28/02/2021",
      "referrerPolicy": "strict-origin-when-cross-origin",
      "body": "__EVENTTARGET=&__EVENTARGUMENT=&__VIEWSTATE=%2FwEPDwUJODI1Mjk2MzA1D2QWAgIDD2QWBAIDDw8WAh4EVGV4dAUXVG90YWwgZGUgcmVnaXN0cm9zIDI4ODlkZAIFDzwrABwCAA8WAh4PRGF0YVNvdXJjZUJvdW5kZ2QYPCsABgEFFCsAAmRkZBgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAQUCZ3beyrZHA%2FHf3zgCu1v%2Bxr6u8mccv%2FLxY5C%2FdOaWKN6qKw%3D%3D&__VIEWSTATEGENERATOR=83655416&__EVENTVALIDATION=%2FwEdAAuB%2BwH1DMFDcphSPL0MxAJn60z594LnSzU4S6PQAbT3rq%2FpNZX4WBzijQTqPezGz2dY%2FqzzKPnlcn%2BXMSt9fV%2BYNnYkKrbN%2FO3%2F80cAQIl6hUr4E8rNR8j1g%2BULBBtNNPuHCckrAtLUuxosmebAadYwj4xXkHQ%2BYn1IHjIKmCBZQdC5fxwZGSiI1vGz9jQ2Ev%2FceTYcQ5kHq6daWfdlKKqcYwT%2BSUyhF5e0clSSWBJgLtry7qtnT1wEt1THtUVXxvkGZLPxgiuHSeixPZSDKbNm&btnExportar=Exportar+a+Excel&gv%24DXSelInput=&gv%24DXKVInput=%5B%5D&gv%24CallbackState=%2F%%2F%%2F%%2F%%2F%%2F%%2F%%2F%%2F%%2F%%3D&hdpidactividad=127&hdpiddisa="+disa+"&hdpidred=0&hdpidmicrored=0&hdpidestablecimiento=0&hdprandoedad=0&hdpfecini=01%2F02%2F2021&hdpfecfin=31%2F12%2F2021&DXScript=1_171%2C1_94%2C1_164%2C1_104%2C1_138%2C1_114%2C1_121%2C1_152&DXCss=0_3598%2C0_3741%2C1_12%2C0_3600%2C0_3745%2C0_3592%2C1_5%2C0_3594",
      "method": "POST",
      "mode": "cors"
    }).then( async res => {
  ...
  async consultarDni(num_doc: string) {
    ...
    let resp = await fetch("https://websalud.minsa.gob.pe/hisminsa/his/his?_dc=1620491204307&confighistorialpacid=1&idtipodoc=1&numdoc=" + num_doc + "&idpersona=20523490&paciente=ALEX%20EDWIN%20ARANA%20RABANAL&fecnacimiento=30%2F05%2F1983&edadactual=37%20a%C3%B1o(s)%2011%20mes(es)%208%20d%C3%ADa(s)&C=HISTORIALATENCIONES&S=SEARCH&page=1&start=0&limit=25", {
      "headers": {
        "accept": "*/*",
        "accept-language": "es-ES,es;q=0.9,en;q=0.8",
        "cache-control": "no-cache",
      ...
      let r = await respuesta.body.on('end', () => {

        console.log('termino')

        //let g=JSON.parse(  buf.toString())
        res = JSON.parse(data)
        return (res)
  ...
  devolverVacunaCovidDia(anio: string, mes: string, dia: string) {
    ...
    fetch("https://wsalud.minsa.gob.pe/reporteshis/Inmunizaciones/Vacunados.aspx?parametro=127-7-0-0-0-0-06%2f05%2f2021-06%2f05%2f2021", {
      ...
      const pipeline = chain([
        fs.createReadStream(this.RUTA_CARGAR + '/vacu_' + anio + '_' + mes + '_' + dia + '.csv'),
        ...
        data => {
          ...
          return value && value.num_doc === '80188270' ? data : null;
        }
      ]);
  ...
  async consultarDniReniec(dni: string) {
    ...
    let resp = await fetch("https://websalud.minsa.gob.pe/hisminsa/his/paciente", {
      ...
      "referrer": "https://websalud.minsa.gob.pe/hisminsa/",
      "referrerPolicy": "strict-origin-when-cross-origin",
      "body": "C=PACIENTE&S=INFOGETBYIDRENIEC&idtipodoc=1&numdoc=41935041",
      "method": "POST",
      "mode": "cors"
    }).then(respuesta => {
